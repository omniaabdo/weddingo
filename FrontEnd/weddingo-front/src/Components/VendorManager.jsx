...
import { FaHome, FaCamera, FaBus, FaEnvelope,FaSearch, FaHeart, FaCheck } from 'react-icons/fa';
...
const vendors = [
  ...
  { name: 'dress && Makeup', icon: <FaEnvelope />, link: '/vendors/invitations' },
];
