...
import AddImagesModuleForVanue from "../modules/AddImagesModuleForVanue";
export default function VenueServiceDetails() {
  const { id } = useParams();
      ...
      <section>
        <MinBreadcrumb
          links={[
            ...
            {
              title: "تفاصيل",
              link: `/profile/my-services/Venues/details/${id}`,
            },
          ]}
        />
